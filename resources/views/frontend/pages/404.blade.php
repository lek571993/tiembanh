	...
	<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="../index.blade.php" id="logo"><img src="assets/dest/images/logo-cake.png" width="200px" alt=""></a>
				</div>
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-caption">
									...
									<div class="center">
										<div class="space10">&nbsp;</div>
										<a href="../checkout.blade.php" class="beta-btn primary text-center">Đặt hàng <i class="fa fa-chevron-right"></i></a>
									</div>
								</div>
							</div>
						</div> <!-- .cart -->
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
								<li><a href="../product_type.blade.php">Sản phẩm 1</a></li>
								<li><a href="../product_type.blade.php">Sản phẩm 2</a></li>
								<li><a href="../product_type.blade.php">Sản phẩm 4</a></li>
							</ul>
						</li>
						<li><a href="../about.blade.php">Giới thiệu</a></li>
						<li><a href="../contacts.blade.php">Liên hệ</a></li>
					</ul>
					<div class="clearfix"></div>
				</nav>
			</div> <!-- .container -->
