		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{!! route('front.index') !!}">Home</a> / <span>Shopping Cart</span>
				</div>
			</div>
		...
		<div id="content">
				...
				<table class="shop_table beta-shopping-cart-table" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="product-name">Cập nhật</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr class="cart_item">
							<td class="product-name">
								<div class="media">
									<img style="width: 150px; height: 150px" class="pull-left" src="{!! url('resources/views/upload/'.$item->options['image']) !!}" alt="">
							...
							<form action="" method="post">
								...
								<td class="product-quantity">
									<input type="number" id="txtQty" value="{!! $item->qty !!}" style="height: 30px; text-align: center"/>
								</td>
								...
								<td class="product-remove">
									<a href="{!! route('front.delCart', $item->rowId) !!}" class="remove" title="Remove this item"><i class="fa fa-trash-o"></i></a>
								</td>
					...
					<tfoot>
						<tr>
							<td colspan="6" class="actions">
								<a href="{!! route('front.getCheckout') !!}" class="beta-btn primary" name="proceed">Thanh toán đặt hàng<i class="fa fa-chevron-right"></i></a>
								<a href="{!! route('front.index') !!}" class="beta-btn primary" name="update_cart">Tiếp tục mua sắm<i class="fa fa-chevron-right"></i></a>
							</td>
						</tr>
					</tfoot>
				</table>
			...
			<div class="cart-collaterals">
				...
				<div class="cart-totals pull-right">
					...
					<div class="cart-totals-row"><span>Sản phẩm:</span> <span>{!! Cart::total(0, '.', '.') !!} VNĐ</span></div>
					<div class="cart-totals-row"><span>Shipping:</span> <span>Free Shipping</span></div>
					<div class="cart-totals-row"><span>Thanh toán:</span> <span>{!! Cart::total(0, '.', '.') !!} VNĐ</span></div>
				</div>
